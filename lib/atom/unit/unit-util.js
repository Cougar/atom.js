...
BaseUnit.prototype.implement = function(interfaceName, metadataOverrides, callback) {
  ...
  var interfaceCommands = interfaces[interfaceName].commandsDef;
  Object.keys(interfaceCommands).forEach(function(commandName) {
    this['send' + commandName] = interfaceCommands[commandName].bind(this);
  }.bind(this));

  var interfaceMetadata = interfaces[interfaceName].metadataDef;
